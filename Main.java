...
public class Main {
    ...
    public static void main(String[] args)
    {
        ...
        //int opção2 = 0;
        int tamanho = 0;
        String nameMensagem; // para quem eu quero enviar a mensagem
        String remetente; // quem está enviando a mensagem
        String texto; // texto da mensagem
        int g = 1, m = 0;
        int i = 0, r = 0, j = 0;
        int cont02 = 80;
        int contador = 0; // regular quem entra e sai do loop
        int contador1 = 0;
        //int v = 0;
        //int cont03 = 0;
        String name01;
        ...
        //ArrayList<Usuario> Seguidor = null;
        ...
        senha = 0;
        //r = 0;
        //Usuario p = contaiface.get(i); // necessaria pra uilizar a conta
        //Usuario c = contaiface.get(r); // necessaria para comparar
            ...
            else if(opção == 3)
            {
                ...
                {   
                    ...
                    if(p.getSenha() == senha) // PONHA NUMEROS PARA COMPARAR
                    {
                        ...
                        p.indi(name01); //c
                        //cont01 = 1;
                        //p.men.get(i).printMensagem().get(i);
                        ...
                        while(cont02 != 9)
                        {
                            ...
                            switch(cont02){
                                ...
                                for(i = 0; i < tamanho; i++)
                                {
                                    if(p.getName().equals(nameMensagem))
                                    {
                                        System.out.println("Digite a mensagem que você deseja enviar:");
                                        texto = Ler.nextLine();
                                        p.Mensagem(nameMensagem, remetente, texto, g);                                      
                                        System.out.println("Mensagem enviada!");
                                    }
                                }
                                ...
                                /*
                                // ESSE FOR SERVIA PARA ADICIONAR UMA LISTA DE MENSAGENS A UMA LISTA DE STRIGS
                                // UMAS LISTA APENAS PARA GUARDAR AS MENSAGENS, PORÉM NÃO DAVA PRA SABER QUEM
                                // ERA O REMETENTE
